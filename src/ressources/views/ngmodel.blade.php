...
<div class="row">
	<md-grid-list md-cols="1" md-cols-sm="2" md-cols-md="3" md-cols-gt-md="6" md-row-height-gt-md="1:1" md-row-height="1:1" md-gutter="8px" md-gutter-gt-sm="4px">
		<md-grid-tile ng-repeat="item in uploader.queue"
			                  md-rowspan="1"
			                  md-colspan="1"
			                  md-colspan-sm="1"
			                  md-colspan-xs="1"
	...
	<md-input-container ryupload ng-model="data">
		<input type="file" name="file" aria-label="Ajouter des photos" nv-file-select uploader="uploader" multiple filters="allmedias" required/>
	</md-input-container>	
</div>
